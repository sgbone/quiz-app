...
const QuestionCard = ({ question }: QuestionCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-lg rounded-3xl shadow-2xl p-8 transition-colors duration-300 h-full flex flex-col"
    >
      <div>
      ...
      <div className="mt-auto pt-6">
        {!hasAnswered && userAnswers.length > 0 && (
          <button
            ...
            className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all"
          >
            Kiểm tra đáp án
          </button>
        )}
