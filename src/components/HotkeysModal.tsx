...
const hotkeys = [
  ...
  { action: "Thoát (về trang chủ)", keys: ["Esc"] },
];
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-800">Phím tắt</h2>
            </div>
            ...
            <button
              onClick={onClose}
              className="mt-8 w-full bg-gray-800 hover:bg-gray-900 text-white font-semibold py-3 rounded-lg"
            >
              Đã hiểu
            </button>
          </motion.div>
